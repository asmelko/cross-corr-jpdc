...
std::unordered_map<std::string, std::function<int(
    ...
    return std::unordered_map<std::string, std::function<int(
        ...
        {"nai_shuffle_multimat_both_work_distribution_n_to_m_orig", run_measurement<naive_shuffle_multimat_both_work_distribution_n_to_m_orig<DATA_TYPE, BENCH_TYPE, pinned_allocator<DATA_TYPE>>>},
        ...
        {"nai_shuffle_multirow_both_one_to_one_orig", run_measurement<naive_shuffle_multirow_both_one_to_one_orig<DATA_TYPE, BENCH_TYPE, pinned_allocator<DATA_TYPE>>>},
